<template>
  <div class="modal fade" :id="`view-answers-to-friend-quiz-modal-${attempt.tempId}`" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
      ...
      <div class="modal-content bg-dark">
        <div class="modal-header">
          <h5 class="modal-title text-left" id="exampleModalLongTitle">
            <b>{{ quiz.name }}</b>
            <br>
            <small>Suas respostas para <u>{{ friend.displayName }}</u></small>
          </h5>
...
export default {
  name: 'ViewAnswersToFriendQuizModal',
