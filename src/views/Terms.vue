<template>
  <div class="text-white">
    ...
    <p>
      ...
      intellectual property rights related to it, still belong to Artur
      Constanzi Sponchiado.
    </p>
    <p>
      Artur Constanzi Sponchiado is committed to ensuring that the app is as
      useful and efficient as possible. For that reason, we reserve the right to
      make changes to the app or to charge for its services, at any time and for
    ...
    <p>
      The MeQuiz: Seus amigos te conhecem? app stores and processes personal
      data that you have provided to us, in order to provide my Service. It’s
      ...
      security features and it could mean that the MeQuiz: Seus amigos te
      conhecem? app won’t work properly or at all.
    </p>
    <p>
      You should be aware that there are certain things that Artur Constanzi
      Sponchiado will not take responsibility for. Certain functions of the app
      will require the app to have an active internet connection. The connection
      can be Wi-Fi, or provided by your mobile network provider, but Artur
      Constanzi Sponchiado cannot take responsibility for the app not working at
      full functionality if you don’t have access to Wi-Fi, and you don’t have
    ...
    <p>
      Along the same lines, Artur Constanzi Sponchiado cannot always take
      ...
      it on to avail the Service, Artur Constanzi Sponchiado cannot accept
      responsibility.
    </p>
    <p>
      With respect to Artur Constanzi Sponchiado’s responsibility for your use
      of the app, when you’re using the app, it’s important to bear in mind that
      ...
      can make it available to you. Artur Constanzi Sponchiado accepts no
      liability for any loss, direct or indirect, you experience as a result of
    ...
    <p>
      ...
      Artur Constanzi Sponchiado does not promise that it will always update the
