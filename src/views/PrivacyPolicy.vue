<template>
  <div>
    ...
    <p>
      Artur Constanzi Sponchiado built the MeQuiz: Seus amigos te conhecem? app
      as an Ad Supported app. This SERVICE is provided by Artur Constanzi
      Sponchiado at no cost and is intended for use as is.
    </p>
    <p>
    ...
    <p>
      ...
      Terms and Conditions, which is accessible at MeQuiz: Seus amigos te
      conhecem? unless otherwise defined in this Privacy Policy.
    </p>
    <p><strong>Information Collection and Use</strong></p>
    <p>
      For a better experience, while using our Service, I may require you to
      provide us with certain personally identifiable information, including but
      not limited to PHONE NUMBER. The information that I request will be
